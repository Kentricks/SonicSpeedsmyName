...
class appProdProjectContainer extends Container
{
    ...
    {
        require_once '/Users/nguyenkenny/ETNA/2SN/app/cache/prod/jms_diextra/doctrine/EntityManager_516e6e37d9369.php';
        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_default_7c69a62ae6cd7a18cc682c9f5609022d');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_7c69a62ae6cd7a18cc682c9f5609022d');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_7c69a62ae6cd7a18cc682c9f5609022d');
        ...
        $d->setProxyDir('/Users/nguyenkenny/ETNA/2SN/app/cache/prod/doctrine/orm/Proxies');
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager516e6e37d9369_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($e, $this);
    }
    ...
    protected function getJmsDiExtra_Metadata_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('/Users/nguyenkenny/ETNA/2SN/app/cache/prod/jms_diextra/metadata'));
        return $instance;
    }
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('/Users/nguyenkenny/ETNA/2SN/app/logs/prod.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $c->setKernel($b);
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/Users/nguyenkenny/ETNA/2SN/app/cache/prod/profiler', '', '', 86400), $a);
        $instance->disable();
        $instance->add($c);
    ...
    protected function getSecurity_Access_DecisionManagerService()
    {
        ...
        $a->setCacheDir('/Users/nguyenkenny/ETNA/2SN/app/cache/prod/jms_security/expressions');
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/Users/nguyenkenny/ETNA/2SN/app/cache/prod/secure_random.seed', $this->get('monolog.logger.security'));
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('/Users/nguyenkenny/ETNA/2SN/app/cache/prod/sessions');
    }
    protected function getSession_Storage_FilesystemService()
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/Users/nguyenkenny/ETNA/2SN/app/cache/prod/sessions');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => '/Users/nguyenkenny/ETNA/2SN/app/cache/prod/translations', 'debug' => false));
    }
    protected function getTwigService()
    {
        $a = $this->get('security.context');
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'exception_controller' => 'twig.controller.exception:showAction', 'cache' => '/Users/nguyenkenny/ETNA/2SN/app/cache/prod/twig', 'charset' => 'UTF-8', 'paths' => array()));
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/Users/nguyenkenny/ETNA/2SN/app/../web', false);
    }
    ...
    {
        $this->services['security.extra.metadata_factory'] = $instance = new \Metadata\MetadataFactory(new \Metadata\Driver\LazyLoadingDriver($this, 'security.extra.metadata_driver'), new \Metadata\Cache\FileCache('/Users/nguyenkenny/ETNA/2SN/app/cache/prod/jms_security', false));
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/Users/nguyenkenny/ETNA/2SN/app/cache/prod');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => false,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/Users/nguyenkenny/ETNA/2SN/app/cache/prod',
            ...
            'session.save_path' => '/Users/nguyenkenny/ETNA/2SN/app/cache/prod/sessions',
            ...
            'profiler.storage.dsn' => 'file:/Users/nguyenkenny/ETNA/2SN/app/cache/prod/profiler',
            ...
            'router.resource' => '/Users/nguyenkenny/ETNA/2SN/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/Users/nguyenkenny/ETNA/2SN/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'swiftmailer.spool.memory.path' => '/Users/nguyenkenny/ETNA/2SN/app/cache/prod/swiftmailer/spool',
            ...
            'assetic.cache_dir' => '/Users/nguyenkenny/ETNA/2SN/app/cache/prod/assetic',
            ...
            'doctrine.orm.proxy_dir' => '/Users/nguyenkenny/ETNA/2SN/app/cache/prod/doctrine/orm/Proxies',
            ...
            'jms_aop.cache_dir' => '/Users/nguyenkenny/ETNA/2SN/app/cache/prod/jms_aop',
            ...
            'jms_di_extra.cache_dir' => '/Users/nguyenkenny/ETNA/2SN/app/cache/prod/jms_diextra',
            'jms_di_extra.disable_grep' => false,
            'jms_di_extra.doctrine_integration' => true,
            'jms_di_extra.cache_warmer.controller_file_blacklist' => array(
            ),
            'jms_di_extra.doctrine_integration.entity_manager.file' => '/Users/nguyenkenny/ETNA/2SN/app/cache/prod/jms_diextra/doctrine/EntityManager_516e6e37d9369.php',
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager516e6e37d9369_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
            ...
            'security.extra.cache_dir' => '/Users/nguyenkenny/ETNA/2SN/app/cache/prod/jms_security',
