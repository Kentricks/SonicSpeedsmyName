...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/Users/Ophelie/Sites/2SN-git/2SN/app/cache/prod/annotations', false);
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b->setNamespace('sf2orm_default_99c814d9c36c2d350af60ad2741067e0');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_99c814d9c36c2d350af60ad2741067e0');
        ...
        $d->setProxyDir('/Users/Ophelie/Sites/2SN-git/2SN/app/cache/prod/doctrine/orm/Proxies');
    ...
    protected function getJmsDiExtra_Metadata_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('/Users/Ophelie/Sites/2SN-git/2SN/app/cache/prod/jms_diextra/metadata'));
        return $instance;
    }
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('/Users/Ophelie/Sites/2SN-git/2SN/app/logs/prod.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $c->setKernel($b);
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/Users/Ophelie/Sites/2SN-git/2SN/app/cache/prod/profiler', '', '', 86400), $a);
        $instance->disable();
        $instance->add($c);
    ...
    protected function getSecurity_Access_DecisionManagerService()
    {
        ...
        $a->setCacheDir('/Users/Ophelie/Sites/2SN-git/2SN/app/cache/prod/jms_security/expressions');
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/Users/Ophelie/Sites/2SN-git/2SN/app/cache/prod/secure_random.seed', $this->get('monolog.logger.security'));
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('/Users/Ophelie/Sites/2SN-git/2SN/app/cache/prod/sessions');
    }
    protected function getSession_Storage_FilesystemService()
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/Users/Ophelie/Sites/2SN-git/2SN/app/cache/prod/sessions');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => '/Users/Ophelie/Sites/2SN-git/2SN/app/cache/prod/translations', 'debug' => false));
    }
    protected function getTwigService()
    {
        $a = $this->get('security.context');
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'exception_controller' => 'twig.controller.exception:showAction', 'cache' => '/Users/Ophelie/Sites/2SN-git/2SN/app/cache/prod/twig', 'charset' => 'UTF-8', 'paths' => array()));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/Users/Ophelie/Sites/2SN-git/2SN/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views', 'Twig');
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/Users/Ophelie/Sites/2SN-git/2SN/app/../web', false);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/Users/Ophelie/Sites/2SN-git/2SN/app/cache/prod/assetic/assets');
    }
    ...
    {
        $this->services['security.extra.metadata_factory'] = $instance = new \Metadata\MetadataFactory(new \Metadata\Driver\LazyLoadingDriver($this, 'security.extra.metadata_driver'), new \Metadata\Cache\FileCache('/Users/Ophelie/Sites/2SN-git/2SN/app/cache/prod/jms_security', false));
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/Users/Ophelie/Sites/2SN-git/2SN/app/cache/prod');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => false,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/Users/Ophelie/Sites/2SN-git/2SN/app/cache/prod',
            ...
            'kernel.bundles' => array(
                ...
                'PHPWSocialBundle' => 'PHPW\\SocialBundle\\PHPWSocialBundle',
            ...
            'session.save_path' => '/Users/Ophelie/Sites/2SN-git/2SN/app/cache/prod/sessions',
            ...
            'profiler.storage.dsn' => 'file:/Users/Ophelie/Sites/2SN-git/2SN/app/cache/prod/profiler',
            ...
            'router.resource' => '/Users/Ophelie/Sites/2SN-git/2SN/app/cache/prod/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/Users/Ophelie/Sites/2SN-git/2SN/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'swiftmailer.spool.memory.path' => '/Users/Ophelie/Sites/2SN-git/2SN/app/cache/prod/swiftmailer/spool',
            ...
            'assetic.cache_dir' => '/Users/Ophelie/Sites/2SN-git/2SN/app/cache/prod/assetic',
            ...
            'doctrine.orm.proxy_dir' => '/Users/Ophelie/Sites/2SN-git/2SN/app/cache/prod/doctrine/orm/Proxies',
            ...
            'jms_aop.cache_dir' => '/Users/Ophelie/Sites/2SN-git/2SN/app/cache/prod/jms_aop',
            ...
            'jms_di_extra.cache_dir' => '/Users/Ophelie/Sites/2SN-git/2SN/app/cache/prod/jms_diextra',
            ...
            'security.extra.cache_dir' => '/Users/Ophelie/Sites/2SN-git/2SN/app/cache/prod/jms_security',
