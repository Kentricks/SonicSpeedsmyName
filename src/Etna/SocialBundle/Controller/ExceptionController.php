...
class ExceptionController extends BaseController
{
    ...
    protected function findTemplate(Request $request, $format, $code, $debug)
    {
        ...
        if (!$debug) {
            $template = new TemplateReference('SocialBundle', 'Exception', $name.$code, $format, 'twig');
        ...
        $template = new TemplateReference('SocialBundle', 'Exception', $name, $format, 'twig');
        if ($this->templateExists($template)) {
            return $template;
        }
        ...
        return new TemplateReference('SocialBundle', 'Exception', $name, 'html', 'twig');
    }
